...
public class WebSearchEngine {
  ...
  private WebSearchEngine(Builder builder) {
  ...
  private static WebSearchOrganicResult toWebSearchOrganicResult(WebSearchResult result) {
  ...
  private static boolean includeResult(WebSearchResult result) {
  ...
  public WebSearchResults search(WebSearchRequest webSearchRequest) {
      List<WebSearchResult> results = client.search(webSearchRequest);

      List<WebSearchOrganicResult> organicResults = results.stream()
              .filter(WebSearchEngine::includeResult)
              .map(WebSearchEngine::toWebSearchOrganicResult)
  ...
  public static class Builder {
      ...
      public WebSearchEngine build() {
          return new WebSearchEngine(this);
      }
  }
}
